...
export async function getEventById(id) {
    return await client.db("zen-event-app").collection("event_new").findOne({ _id: new ObjectId(id) });
}

export async function updateEventById(id, data) {
    return await client.db("zen-event-app").collection("event_new").updateOne({ _id: new ObjectId(id) }, { $set: data });
}

export async function deleteEventById(id) {
    return await client.db("zen-event-app").collection("event_new").deleteOne({ _id: new ObjectId(id) });
}
export async function deleteWebinarById(id) {
    return await client.db("zen-event-app").collection("event_webinar").deleteOne({ _id: new ObjectId(id) });
}
export async function updateEventRegistrationById(id, participantlist) {
    return await client.db("zen-event-app").collection("event_new").updateOne({ _id: new ObjectId(id) }, { $set: { participantlist: participantlist } });
}
export async function getWebinarById(id) {
    return await client.db("zen-event-app").collection("event_webinar").findOne({ _id: new ObjectId(id) });
}
export async function updateWebinarById(id, data) {
    return await client.db("zen-event-app").collection("event_webinar").updateOne({ _id: new ObjectId(id) }, { $set: data });
}
export async function updateWebinarRegistrationById(id, participantlist) {
    return await client.db("zen-event-app").collection("event_webinar").updateOne({ _id: new ObjectId(id) }, { $set: { participantlist: participantlist } });
}
